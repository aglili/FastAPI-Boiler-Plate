...
def init():
    ...
    This function prompts the user to enter a project name and creates a new folder
    with that name in the current working directory. If a folder with the same name
    already exists, it prints a message and returns.

    The function then copies all the files and directories from
    the `BOILERPLATE_PATH` directory to the newly created project folder.
